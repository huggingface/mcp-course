...
* [LLM Course](https://huggingface.co/learn/llm-course/en/chapter0/1) will guide you through the basics of using and building with LLMs.
* [Agents Course](https://huggingface.co/learn/agents-course/en/unit0/introduction) will guide you through building AI agents with LLMs.
