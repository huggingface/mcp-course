...
Then, we will need to log in to the Hugging Face Hub to access the MCP servers. You can do this with the `hf` command line tool. You will need a [login token](https://huggingface.co/docs/huggingface_hub/v0.32.3/en/quick-start#authentication) to do this.
